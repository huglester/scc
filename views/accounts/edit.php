...
<?php echo Form::open(); ?>
	...
	<div class="control-group <?php echo ($validation->error('first_name')) ? 'error' : ''; ?>">
		<div class="controls">
			<input class="span12" type="text" name="first_name" value="<?php echo $account['first_name']; ?>" id="inputFirstName" placeholder="FirstName">
		</div>
	</div>
	<div class="control-group <?php echo ($validation->error('last_name')) ? 'error' : ''; ?>">
		<div class="controls">
			<input class="span12" type="text" name="last_name" value="<?php echo $account['last_name']; ?>" id="inputLastName" placeholder="LastName">
		</div>
	</div>
	<div class="control-group <?php echo ($validation->error('email')) ? 'error' : ''; ?>">
		<div class="controls">
			<input class="span12" type="text" name="email" value="<?php echo $account['email']; ?>" id="inputEmail" placeholder="Email">
		</div>
	</div>
	<div class="control-group <?php echo ($validation->error('username')) ? 'error' : ''; ?>">
		<div class="controls">
			<input class="span12" type="text" name="username" value="<?php echo $account['username']; ?>" id="inputUsername" placeholder="Username">
		</div>
	</div>
	<div class="control-group">
		<div class="controls">
			<select name="group" class="span12">
				...
				<option value="<?php echo $key; ?>" <?php echo ($key == $account['group']) ? 'selected' : ''; ?>><?php echo $value['name']; ?></option>	
				<?php endforeach ?>
